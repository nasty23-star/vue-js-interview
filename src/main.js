import Vue from "vue";
// import axios from "axios"; раскомментировать, чтобы использовать аксиос для запроса на сервер
...
const store = new Vuex.Store({
  ...
  actions: {
    // если раскомментировать то идет аксиос запрос на моковый адрес, который возвращает один объект из массива users
    // fetchUsers({ commit }) {
  ...
  mutations: {
    ...
    // setUsers(state, user) { добавляет полученный с помощью аксиос объект в общий массив
